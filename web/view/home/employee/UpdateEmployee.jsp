            ...
            <div class="container">
                ...
                <div>
                    ...
                    <table align="center">
                        ...
                        <tr>
                            <td>Họ tên:</td>
                            <td> <input type="text" name="name" value="<c:out value="${employee.name}"/> "></td>
                        </tr>
                        <tr>
                            <td>Chức vụ:</td>
                            <td> <input type="text" name="position" value="<c:out value="${employee.position}"/> "> </td>
                        </tr>
                        <tr>
                            <td>Địa chỉ:</td>
                        ...
                        <tr>
                            <td>Số điện thoại:</td>
                            <td> <input type="text" name="phone" value="<c:out value="${employee.phone}"/> "> </td>
                        </tr>
                        <tr>
